...
Obviamente la calidad de la imagen obtenida no es la deseada, lo que nos permite recalcar que el tema de compresión es un tema de mucha variabilidad dependiente a lo que el usuario desee obtener.

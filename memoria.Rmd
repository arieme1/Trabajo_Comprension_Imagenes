...
### Compresión de imágenes multi-level
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{./data/Memoria/py-lena-comp-miguel.png}
  \caption{ESCRIBIR}
  \label{fig:miguel-fig-1}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{./data/Memoria/py-max-descomp.png}
  \caption{Representación de la descomposición por niveles en Python.}
  \label{fig:miguel-fig-2}
\end{figure}
